...
*/
/** @file
 *  Type aliases for per-player object list storage (no globals, no session coupling).
 *  Kept separate from objmem.h so game_world.h does not pull objmem or gamesessionworlds.
 */

#ifndef __INCLUDED_SRC_OBJECT_LISTS_TYPES_H__
#define __INCLUDED_SRC_OBJECT_LISTS_TYPES_H__
...
#endif // __INCLUDED_SRC_OBJECT_LISTS_TYPES_H__
