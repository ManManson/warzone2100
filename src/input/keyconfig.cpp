...
static void initializeKeyFunctions(std::vector<KeyFunctionInfo>& entries)
{
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::DEBUG_MISC,          KeyMappingType::HIDDEN,      kf_ToggleShowHeatmap,                                          "ToggleShowHeatmap",            N_("Toggle path heatmap overlay"),                   {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_LCTRL,      KEY_CODE::KEY_N             } }}, true));
